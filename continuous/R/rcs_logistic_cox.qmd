---
title: "**Including and Presenting Non-Linear Associations in Regression Models with Restricted Cubic Splines**"
author: 
  - Andrea Discacciati
  - Michael G. Palazzolo
  - Jeong-Gun Park
...
Load the packages, the dataset, and the functions (**note**: the following packages are required
to use the function `data_or_hr` and `data_probability`: `Epi`, `aod`, `survival`, `Hmisc`, `glmtoolbox`) .
